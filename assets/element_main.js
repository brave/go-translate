...
*/
  var aa = '" style="background-image:url(',
    ...
    ha = '</span></td><td class="inv-te-banner-margin"></td><td nowrap><div class="inv-te-button"><div><button id="',
    ...
    wa = "[inv.net.IframeIo] Unable to send, already active.",
    ...
    hb = "inv-inline-block ",
    ib = "inv-menuheader",
    jb = "inv-menuseparator",
    kb = "inv-option",
    lb = "inv-option-selected",
    mb = "inv-te-menu-value",
    nb = "inv-te-menu2-item-selected",
    ob = "inv-te-spinner-animation-show",
    pb = "inv-te-spinner-pos-show",
    qb = "hidden",
    rb = "hide",
    sb = "horizontal",
    tb = "https://translate.brave.com",
    ub = "https://invalid-url",
    vb = "https://invalid-url",
  ...
  v.Ia = function (a, b) {
    ...
    Ni(b, ["inv-inline-block", this.ha()]);
    return fm.G.Ia.call(this, a, b)
  };
  v.ha = function () {
    return "inv-custom-button"
  };
  function hm(a, b) {
    if (a)
  ...
  v.send = function (a, b, c, d) {
    if (this.g) throw Error("[inv.net.XhrIo] Object is active with another request=" + this.m + "; newUri=" + a);
  ...
  v.setVisible = function (a) {
    ...
    if (a) {
      if (!this.ic && this.ce()) {
        ...
        this.qc == Xb ? (this.F.style.visibility = cc, N(this.F,
          !0)) : this.qc == Eb && this.jb();
        this.ic = !0;
        this.Oe = Date.now();
  ...
  Kn.prototype.A = function (a) {
    if (this.g != a && (0 != this.g || !(this.isVisible() && 1 == a || !this.isVisible() && -1 == a))) {
      ...
      if (Dn()) {
        ...
        this.h.play();
        Xj(this.h, $a, A(this.m, this)); - 1 == a ? Xj(this.h, $a, A(this.setVisible, this,
          !1)) : this.setVisible(!0)
  ...
  v.fb = function () {
    ...
    return Array.isArray(a) ? (a = Rc(a, function (b) {
      return ni(b) && (Mi(b, "inv-menuitem-accel") || Mi(b, "inv-menuitem-mnemonic-separator")) ? "" : Di(b)
  ...
  function Pq(a, b, c, d, e, f, h, k, l) {
    ...
    l && this.m.oa(!1);
    if (0 < this.U)
      for (a = this.m, a.B = !0, b = 0; b < a.l; b++) h = $h(g, "inv-menu", ""), e = $h(g, null, h), h = new Kn(e, h), a.m[b] = h, document.body.appendChild(e);
    this.m.ka(c);
    this.o = k || null;
    this.ob = null != d ? d : -1;
    this.R = fn.ca();
      ...
      if (null == a.target && null != this.l) this.R.log("editpopupclk"), en(this.K, 233), null != this.o && this.o.g(!0), this.l.l(cr(this)), this.Ra = this.B.s().style.display != r, this.B.reset(), null != this.o ? this.B.oa(this.o.h.style.display != r) : this.B.oa(!1), $q(this, !1);
        ...
        if (null != b && null != a.target) {
          var d = b,
            e = this.m.o.get(Ac(d));
          this.h.ib(d, c);
          c == Zq(e, 0) ? (Oi(d, Da), 0 == Qh().length && ($q(this,
            !1), ar(this, !1))) : (L(d, Da), $q(this, !0), ar(this, !0));
  ...
  var ir = window.google && window.google.translate && window.google.translate.v || "",
    ...
    yr = hr._puh ||
      "",
    zr = "//" + yr + ea + pr,
    Ar = "https://invalid-url" + ("en" == jr ? "" : "#/en/" + jr);
  function Br(a) {
  ...
  function Mr(a, b) {
    if ((D || pf) && window.location.hostname != document.domain) {
      ...
      a.src = "javascript:void(document.write(\"<script>document.domain='" + document.domain + "';parent['" + c + "']();</script>\"))"
    } else b && b()
  }
  var Nr;
  function Or() {
  ...
  function bs() {
    var a, b;
    void 0 === as && (as = null !== (b = null === (a = $r()) || void 0 === a ? void 0 : a.createPolicy("inv#safe", {
  ...
  function Ls(a) {
    var b = a.Pi,
      c = Z.dd,
      d = Z.qh;
    return gh('<div id="inv-gt-tt" class="skiptranslate" dir="' + I(a.dir) + '"><div style="padding: 8px;"><div><div class="logo"><img src="' + I(uh(b)) + '" width="20" height="20" alt="Brave ' + I(c) + '"/></div></div></div><div class="top" style="padding: 8px; float: left; width: 100%;"><h1 class="title gray">' + fh(d) + '</h1></div><div class="middle" style="padding: 8px;"><div class="original-text"></div></div><div class="bottom" style="padding: 8px;"><div class="activity-links"></div><div class="started-activity-container"><hr style="color: #CCC; background-color: #CCC; height: 1px; border: none;"/><div class="activity-root"></div></div></div><div class="status-message"></div></div>')
  }
  function Ms(a) {
    var b = a.method,
      c = a.Ph,
  ...
  function Ps() {
    return gh('<div class="inv-te-spinner-pos"><div class="inv-te-spinner-animation"><svg xmlns="http://www.w3.org/2000/svg" class="inv-te-spinner" width="96px" height="96px" viewBox="0 0 66 66"><circle class="inv-te-spinner-path" fill="none" stroke-width="6" stroke-linecap="round" cx="33" cy="33" r="30"/></svg></div></div>')
  };
  function Qs(a) {
    R.call(this);
    a = a || {};
  ...
  v.sg = function (a, b) {
    Ht[b ? "add" : "remove"](a, "inv-text-highlight")
  };
  /*
  Math.uuid.js (v1.4)
  http://www.broofa.com
  ...
  */
  ...
  Wu.prototype.m = function (a) {
    var b = Bd(a.href);
    0 == b.indexOf("javascript:") || 0 <= b.indexOf("#") || (this.l.push(a.href), this.h.push(a), a.href = b + "#invtrans/" + this.g + "/" + this.j)
  };
  Wu.prototype.L = function () {
    O.prototype.L.call(this);
    this.restore()
  ...
  v.ji = function (a) {
    if (this.h && this.A) {
      for (var b = 0; b < a.length; b++)
        if (a[b].target && a[b].target.className && typeof a[b].target.className === t && (0 <= a[b].target.className.indexOf(ac) || 0 == a[b].target.className.indexOf("inv-"))) return;
  ...
  v.J = function () {
    ...
    this.l = $h(ma, {
      frameBorder: 0,
      "class": "inv-te-menu-frame skiptranslate",
      title: Z.Kf
    });
  ...
  v.Wf = function () {
    ...
    Mr(this.l, A(function () {
      var d = ti(this.l);
      var e = gh(ia + I(wh(b)) + '"></head><body scroll="no" style="margin:0px;overflow:hidden" dir="' + I(a) + '" marginHeight=0 marginWidth=0 leftMargin=0 topMargin=0 border=0><div id="' + I(c) + '" class="inv-te-menu"></div></body>');
      e = Ug(e);
      d.write(ve(e));
      d.close()
    }, this))
    ...
    for (var b in a)
      if (a[b] !== Object.prototype[b])
        if ("---" == a[b]) {
          var c = {
            link: this.j.J(g, {
              className: "inv-te-menu2-separator",
              value: b
            }),
            Ci: !0
          };
  ...
  v.ya = function (a) {
    if (this.m != a) {
      ...
      for (var b = 0; b < this.A.length; ++b) {
        var c = this.A[b];
        c.Ci || (c.link.className = c.link.value == a && this.g.Sd ? nb : "inv-te-menu2-item")
      }
    }
  };
  function jv(a) {
  ...
  v.J = function () {
    ...
    if (2 == this.g.Qb) {
      ...
      else c = Z.dd, c = '<img src="' + I(uh(vb)) + '" width="37px" height="14px" style="padding-right: 3px" alt="Brave ' +
        I(c) + '">';
      var d = Z.dd;
      var e = gh('<span style="white-space:nowrap"><a class="inv-logo-link" href="' + I(ph(tb)) + '" target="_blank">' + c + fh(d) + "</a></span>");
      c = Z;
      d = c.rh;
      e = Ug(e);
      e = ov(b, {
  ...
  v.T = function () {
    ...
    if (2 == this.g.Qb) {
      ...
      a.className = "inv-te-gadget-simple"
    } else this.l.ka(a),
  ...
  v.J = function () {
    ...
    N(a, !1);
    var b = T(this, Va);
    b = gh('<iframe id="' + I(b) + '" frameBorder=0 src="javascript:\'\'" class="inv-te-ftab-frame skiptranslate" style="visibility:visible"></iframe>');
    Se(a, Ii(b));
    this.X(a)
  };
  v.T = function () {
    ...
    var d = {
      id: this.s().id,
      className: "inv-te-ftab-float"
    };
    this.s().className += " inv-te-ftab-float";
    switch (this.g.pd) {
      case 2:
        var e = gb;
        d.top = 0;
    ...
    Mr(this.A, A(function () {
      ...
      var h = e;
      var k = Z.Mf;
      h = gh(ia + I(wh(b)) + '"></head><body class="inv-te-ftab ' + I(h) + '" scroll="no" style="overflow:hidden" dir="' + I(a) + '"><a id="' + I(c) + '" href="javascript:void(0)" class="inv-te-ftab-link"><img src="' + I(uh(ub)) + aa + I(uh(ur)) + ');background-position:-65px 0px"><span>' + fh(k) + "</span></a></body>");
      h = Ug(h);
      f.write(ve(h));
      f.close()
    }, this))
  ...
  v.J = function () {
    ...
    L(a, Sb);
    var b = T(this, Va);
    b = gh('<iframe id="' + I(b) + '" class="inv-te-banner-frame skiptranslate" frameBorder=0 src="javascript:\'\'" style="visibility:visible"></iframe>');
    Se(a, Ii(b));
    this.X(a)
  };
  v.T = function () {
    ...
    Mr(this.A, A(function () {
      ...
      var pc = Z.dd,
        ...
        Ov = Z.yf,
        Pv = Z.yf;
      Ha = gh(ia + I(wh(b)) + '"></head><body class="inv-te-banner" scroll="no" border=0 dir="' + I(a) + '"><table border=0 cellspacing=0 cellpadding=0 width=100% height=100%><tr valign=middle><td width=1 nowrap><a href="' + I(ph(tb)) + '" class="inv-logo-link" target="_blank"><img src="' + I(uh("https://invalid-url")) +
        '" alt="Brave ' + I(pc) + '"></a></td>' + (Ha ? '<td width=1><img src="' + I(uh(ub)) + '" width="9" height="15" title="' + I(Ha) + '" alt="' + I(Ha) + aa + I(uh(ur)) + ');background-position:-56px 0px;margin:0 4px"></td>' : "") + '<td class="inv-te-banner-margin"></td><td><table border=0 cellspacing=0 cellpadding=0 height=100%><tr id="' + I(c) + '" style="display:none" valign=middle><td nowrap><span class="inv-te-banner-content">' + fh(U) + ha + I(d) + '"><b>' + fh(mm) + '</b></button></div></div></td><td class="inv-te-banner-margin"></td><td nowrap><div class="inv-te-button"><div><button id="' +
        I(u) + '"></button></div></div></td></tr><tr id="' + I(e) + '" style="display:none" valign=middle><td><span class="inv-te-banner-content">' + fh(Lv) + '&nbsp;<span dir="ltr">(<b id="' + I(f) + '"></b>%)</span>&nbsp;<img src="' + I(uh(wr)) + '"></span></td><td class="inv-te-banner-margin"></td><td nowrap><div class="inv-te-button"><div><button id="' + I(h) + '">' + fh(Mv) + fa + I(k) + '" style="display:none"><td><span class="inv-te-banner-content">' + fh(Dg) + ha + I(l) + '">' + fh(Nv) + fa + I(m) + '" style="display:none" valign=middle><td><span id="' +
        I(n) + '" class="inv-te-banner-content"></span></td></tr></table></td><td><td class="inv-te-banner-margin"></td></td><td width=1 id="options"></td><td width=1><a id="' + I(q) + '" class="inv-close-link" href="javascript:void(0)" title="' + I(Ov) + '"><img src="' + I(uh(ub)) + '" width="15" height="15" alt="' + I(Pv) + aa + I(uh(ur)) + ');background-position:-28px 0px"></a></td></tr></table></body>');
      Ha = Ug(Ha);
      qc.write(ve(Ha));
      qc.close()
    }, this))
  ...
  function yv(a, b) {
    ...
    this.C = {};
    if ((a = document.cookie.match(/(^|; )invtransopt=(.*?)(;|$)/)) &&
      a[2])
  ...
  function zv(a) {
    ...
    var c = {
      url: function () {
        var f = window.location.href.match(/#.*invtrans(.*)/);
        return f && f[1]
      },
      cookie: function () {
        var f = document.cookie.match(/(^|; )invtrans=(.*?)(;|$)/);
        return f && f[2]
      }
    },
      d;
  ...
  if (1 == or) {
    var Iv = null,
      Jv = function (a) {
        if (!Iv) {
          var b, c, d, e;
          a && ("key" in a && (b = a.key), "serverParams" in a && (c = a.serverParams), "timeInfo" in a && (d = a.timeInfo), "remoteApiProxyHandlers" in a && (e = a.remoteApiProxyHandlers), (a = (a = null) && a[1] ? a[1] : null) && (c = a));
          a = 0;
          if ("te_lib" == pr || sf) a = 3;
