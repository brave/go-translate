...
function MSGFUNC_PAGE_TRANSLATED_TO(b) {
    return "Brave has automatically translated this page to: " + b
}
...
function MSGFUNC_TRANSLATE_PAGE_TO(b) {
    return "Translate this page to: " + (b + " using Brave Translate?")
}
...
if (p) {
    ...
    var F = "/static/element_main.js".replace("%s",
        q);
    if ("0" == q) {
