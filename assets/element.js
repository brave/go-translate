...
function MSGFUNC_PAGE_TRANSLATED_TO(a) {
    return "Brave has automatically translated this page to: " + a
}
...
function MSGFUNC_TRANSLATE_PAGE_TO(a) {
    return "Translate this page to: " + a + " using Brave Translate?"
}
...
q[12] = MSG_RESTORE;
var MSG_SSL_INFO_LOCAL_FILE = "The content of this local file will be sent to Brave for translation using a secure connection.";
q[13] = MSG_SSL_INFO_LOCAL_FILE;
var MSG_SSL_INFO_SECURE_PAGE = "The content of this secure page will be sent to Brave for translation using a secure connection.";
q[14] = MSG_SSL_INFO_SECURE_PAGE;
var MSG_SSL_INFO_INTRANET_PAGE = "The content of this intranet page will be sent to Brave for translation using a secure connection.";
...
if (_isNS('google.translate.Element')) {
  ...
  c._ctkk = '454063.1480905154';
  var h = 'translate.brave.com';
  var s = (true ? 'https' : window.location.protocol == 'https:' ? 'https' : 'http') + '://';
  var b = s + h;
  c._pah = h;
  c._pas = s;
  c._pbi = 'https://invalid-url';
  c._pci = 'https://invalid-url';
  c._pli = 'https://invalid-url';
  c._plla = h + '/translate_a/l';
  c._pmi = 'https://invalid-url';
  c._puh = 'translate.brave.com';
  c._cjlc(b + '/static/main.js');
})();
})();;
